...
local v224 = (function()
    ...
    ["Title"] = "NO MORE LIFE HUB",
    ["SubTitle"] = " | by @nomorelife",
    ["TabWidth"] = 155,
...
v225:AddButton({
    ["Title"] = "Youtube Channel | @genplayofficial",
    ["Description"] = "Click to Copy",
    ["Callback"] = function()
        setclipboard("https://youtube.com/@genplayofficial-p7q?si=O-9Z0wfCa2qmIbyl")
    end
})
v225:AddButton({
    ...
    ["Description"] = "Click to Copy",
    ["Callback"] = function()
        setclipboard("https://discord.com/invite/Yjp9QKA9we")
    end
})
local v226 = {
    ["Main"] = v224:AddTab({
